...
@Setter
@Entity
@Table(name = "test_security_category_4")
public class TestSecurityCategory4 {
    @Id
    ...
    public TestSecurityCategory4() {}
    public TestSecurityCategory4(String question, String reply_1, String reply_2, String reply_3, int true_reply) {
