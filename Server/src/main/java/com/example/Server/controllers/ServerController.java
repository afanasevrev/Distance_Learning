...
public class ServerController {
    ...
    private String writeTests() {
        ...
        tests.add(new TestSecurityCategory6("Имеют ли право на необходимую оборону лица, имеющие возможность избежать общественно опасного посягательства или обратиться за помощью к другим лицам или органам власти?","Да, имеют.","Нет, не имеют.","Имеют, если посягательство сопряжено с насилием, опасным для жизни обороняющегося.",1));
        tests.add(new TestSecurityCategory6("Подлежит ли возмещению вред, причиненный посягающему лицу в состоянии необходимой обороны, если при этом не было допущено превышения пределов необходимой обороны?","Да, подлежит.","Подлежит частично на основании судебного решения.","Не подлежит.",3));
        tests.add(new TestSecurityCategory6("Превышение мер, необходимых для задержания лица, совершившего преступление (их явное несоответствие характеру и степени общественной опасности совершенного задерживаемым лицом преступления и обстоятельствам задержания), влечет за собой уголовную ответственность:","Во всех случаях причинения вреда здоровью задерживаемого (независимо от наличия или отсутствия умысла).","Только в случаях умышленного причинения смерти, тяжкого или средней тяжести вреда здоровью задерживаемого.","Только в случаях умышленного причинения смерти, тяжкого, средней тяжести или легкого вреда здоровью задерживаемого.",2));
        tests.add(new TestSecurityCategory6("К уголовно наказуемым деяниям относится:","Причинение тяжкого вреда здоровью по неосторожности, совершенное при превышении пределов необходимой обороны.","Умышленное причинение тяжкого вреда здоровью, совершенное при превышении пределов необходимой обороны.","Умышленное причинение средней тяжести вреда здоровью, совершенное при превышении пределов необходимой обороны.",2));
        tests.add(new TestSecurityCategory6("К уголовно наказуемым деяниям относится:","Умышленное причинение тяжкого или средней тяжести вреда здоровью, совершенное при превышении мер, необходимых для задержания лица, совершившего преступление.","Причинение тяжкого или средней тяжести вреда здоровью по неосторожности, совершенное при превышении мер, необходимых для задержания лица, совершившего преступление.","Умышленное причинение легкого вреда здоровью, совершенное при превышении мер, необходимых для задержания лица, совершившего преступление.",2));
        tests.add(new TestSecurityCategory6("Частный охранник, имеющий на посту огнестрельное оружие, выданное ему в охранной организации для осуществления охранных функций, применяет его:","В случаях и в порядке, установленных статьями 16, 18 Закона РФ «О частной детективной и охранной деятельности в РФ».","В случаях и в порядке, установленных статьей 24 Федерального закона «Об оружии», на основаниях, общих для всех граждан Российской Федерации.","В случаях и в порядке, установленных статьями 37, 39 Уголовного кодекса Российской Федерации.",1));
        tests.add(new TestSecurityCategory6("Частный охранник, имеющий на посту гражданское оружие, не являющееся огнестрельным, выданное ему в охранной организации для осуществления охранных функций, применяет его:","В случаях и в порядке, установленных статьи 16, 18 Закона РФ «О частной детективной и охранной деятельности в РФ».","В случаях и в порядке, установленных статьей 24 Федерального закона «Об оружии», на основаниях, общих для всех граждан Российской Федерации.","В случаях и в порядке, установленных статьями 37, 39 Уголовного кодекса Российской Федерации.",2));
